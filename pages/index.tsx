          ...
          <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center md:justify-start">
                <Link href="/contact" className="w-full sm:w-auto px-8 py-5 text-lg bg-blue-600 hover:bg-blue-700 rounded-full font-semibold transition-transform transform hover:scale-105 shadow">
                  Get Started — never miss a lead again!
                </Link>
                <Link href="/contact?demo=true" className="w-full sm:w-auto px-8 py-5 text-lg border border-white hover:bg-white hover:text-black rounded-full font-semibold transition-transform transform hover:scale-105">
                  Book a Demo
                </Link>
              </div>
            </div>
