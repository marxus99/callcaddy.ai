          ...
          <div className="relative z-10 container mx-auto flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-center">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-6 justify-center">
                <a href="tel:+18884577509" className="w-full sm:w-auto w-40 text-center px-8 py-5 text-lg bg-blue-600 hover:bg-blue-700 rounded-full font-semibold transition-transform transform hover:scale-105 shadow">
                  Call Today – Book a Demo
                </a>
                <a href="sms:+18884577509" className="w-full sm:w-auto w-40 text-center px-8 py-5 text-lg border border-white hover:bg-white hover:text-black rounded-full font-semibold transition-transform transform hover:scale-105">
